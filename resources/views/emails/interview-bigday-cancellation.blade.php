...
@section('content')
    Nous vous informons que votre entretien avec <strong>{{ $interviewCompanyName }}</strong> prévu à {{ $interviewBeginsAt }} <strong style="color: red;">a été annulé</strong>.<br><br>
